...
class AppDatabaseCallback : RoomDatabase.Callback() {
    override fun onCreate(db: SupportSQLiteDatabase) {
        ...
        // ==== Insert Budget Dummy ====
        db.execSQL("INSERT INTO budgets (id, name, amount, user_id, created_at) VALUES (1, 'Makan', 500000, 2, 1718300000)")
        db.execSQL("INSERT INTO budgets (id, name, amount, user_id, created_at) VALUES (2, 'Transport', 300000, 2, 1718300001)")
        ...
        db.execSQL("INSERT INTO budgets (id, name, amount, user_id, created_at) VALUES (5, 'Hiburan', 400000, 2, 1718300004)")
