...
class AppDatabaseCallback : RoomDatabase.Callback() {
    override fun onCreate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("INSERT INTO expenses (id, description, amount, date, budget_id, user_id) VALUES (1, 'Nasi Goreng enak pedis pedas uyeaahhhhhhhhhhhhhhhhhhhh', 25000, 1751548112000, 1, 1)")
        db.execSQL("INSERT INTO expenses (id, description, amount, date, budget_id, user_id) VALUES (6, 'Beli Es Teh Jumbo', 50000, 1751461712000, 2, 1)")
        db.execSQL("INSERT INTO expenses (id, description, amount, date, budget_id, user_id) VALUES (2, 'Naik Gojek ngiiiiihhaaaaaaa', 18000, 1751375312000, 2, 1)")
        ...
        db.execSQL("INSERT INTO expenses (id, description, amount, date, budget_id, user_id) VALUES (7, 'Bayar Wifi Kost', 120000, 1749042512000, 6, 1)")
        db.execSQL("INSERT INTO expenses (id, description, amount, date, budget_id, user_id) VALUES (8, 'Beli Paket Data', 30000, 1748956112000, 6, 1)")

        db.execSQL("INSERT INTO expenses (id, description, amount, date, budget_id, user_id) VALUES (9, 'Ngopi di Starbucks', 60000, 1748869712000, 7, 1)")
        db.execSQL("INSERT INTO expenses (id, description, amount, date, budget_id, user_id) VALUES (10, 'Beli Kopi Literan', 50000, 1748783312000, 7, 1)")
        ...
        db.execSQL("INSERT INTO expenses (id, description, amount, date, budget_id, user_id) VALUES (11, 'Beli Novel', 60000, 1746191312000, 8, 1)")
        db.execSQL("INSERT INTO expenses (id, description, amount, date, budget_id, user_id) VALUES (12, 'Beli Buku Kuliah', 30000, 1746277712000, 8, 1)")
